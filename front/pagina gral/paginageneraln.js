let btnjuego1=document.getElementById("juego1")
let btnjuego2=document.getElementById("juego2")
...
juego2.addEventListener("click", function() {
    window.location.href = "../juego 2/juego2.html";
})
juego3.addEventListener("click", function() {
    window.location.href = "../juego 3/juego3.html";
})
juego4.addEventListener("click", function() {
    window.location.href = "../juego 4/juego4.html";
})
